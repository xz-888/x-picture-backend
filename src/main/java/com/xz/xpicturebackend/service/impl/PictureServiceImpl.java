...
import com.xz.xpicturebackend.manager.FileManager;
import com.xz.xpicturebackend.manager.upload.FilePictureUpload;
import com.xz.xpicturebackend.manager.upload.PictureUploadTemplate;
import com.xz.xpicturebackend.manager.upload.UrlPictureUpload;
import com.xz.xpicturebackend.mapper.PictureMapper;
import com.xz.xpicturebackend.model.dto.file.UploadPictureResult;
...
import com.xz.xpicturebackend.model.enmus.PictureReviewStatusEnum;
...
import com.xz.xpicturebackend.service.UserService;
...
public class PictureServiceImpl extends ServiceImpl<PictureMapper, Picture>
    ...
    /**
     * 支持URL/文件两种类型图片上传
     * @param inputSource  输入图片 URL或文件
     * @param pictureUploadRequest 数据库图片记录
    ...
    public PictureVO uploadPicture(Object inputSource, PictureUploadRequest pictureUploadRequest, User loginUser) {
        ...
        // 上传图片，得到信息
        // 都放到public目录下，按照用户 id 划分目录
        String uploadPathPrefix = String.format("public/%s", loginUser.getId());
        // 根据inputSource类型区分上传方式，也可以由前端传入一个type来区分，更优雅
    ...
    public Page<PictureVO> getPictureVOPage(Page<Picture> picturePage, HttpServletRequest request) {
        ...
        // 1. 关联查询用户信息,一次性取出所有当前页的user,省去多次查询数据库带来的性能浪费
    ...
    public QueryWrapper<Picture> getQueryWrapper(PictureQueryRequest pictureQueryRequest) {
        ...
        // JSON 数组查询 还是用like实现，可以参照下面sql优化
        // SELECT * FROM picture WHERE JSON_CONTAINS(tags, '["指环王","测试"]');
        // 需要在程序中编写mybatis的自定义sql实现 todo
