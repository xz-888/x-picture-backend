...
import com.xz.xpicturebackend.common.DeleteRequest;
...
public class PictureController {
     ...
     */
    @PostMapping("/upload")
    //@AuthCheck(mustRole = UserConstant.ADMIN_ROLE)  普通用户也可以上传图片
    ...
    public BaseResponse<Page<PictureVO>> listPictureVOByPageWithCache(@RequestBody PictureQueryRequest pictureQueryRequest,
        ...
        String redisKey = "xypcture:listPictureVOByPage:" + hashKey;
        // 从 Redis 缓存中查询
